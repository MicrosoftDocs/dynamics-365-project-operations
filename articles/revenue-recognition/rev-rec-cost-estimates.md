...
This approach ensures that revenue recognition remains aligned with the initial plan, and any cost overruns are treated as losses rather than revenue triggers.
...
Before using this feature, you must meet the following prerequisites.

### Minimum version required

To use this feature in **Dynamics 365 Project Operations**, you must have the following versions:
...
1. Click **Cost lines**.
1. Select Cost line and in the General tab, Select **Cost to complete method** as **Total forecast - actual**.
1. Enable **Use forecast amount for revenue recognition** to **Yes**. Select this option to use the forecast amount,
