...
When you negotiate purchases for projects with vendors, specify the vendor retention terms that include the percentage or amount to retain. As the vendor delivers items and services, deduct the specified retention percentage or amount from your payment to the vendor. When the project is complete, or reaches an interim stage as specified in the vendor contract, release the retained amount and create a payment to the vendor.
...
Contoso Robotics USA contracts with the vendor Fabrikam to deliver 100 hours of training for the equipment renewal project. The total contract value is USD 30,000 with an agreed purchase price of USD 300 per hour.

Training is delivered in three phases with the following schedule:
...
- Phase 1:
  ...
  - The amount that you pay to the vendor is 12,000.
- Phase 2:
  ...
  - The amount that you pay to the vendor is 8,400. This amount is 9,000 less the 900 retention plus the 300 that was released from the Phase 1 retention.
- Phase 3:
  ...
  - The amount that you pay to the vendor is 9,600. This amount consists of the retained amount of 3,600 plus the 6,000 for completion of Phase 3.
