...
- Copilot in time entry is available as a preview feature for **environments hosted in the United States**, having a Project Operations version starting between _4.103.0.x_ (feature is not available before this version) and  _4.108.X.X_ (both included).
