...
1. In the dialog that appears, clear the **Make agent available in Microsoft Copilot** checkbox, and then select **Add channel**. At the top of the page, you receive a confirmation message that states, "The channel was added."
