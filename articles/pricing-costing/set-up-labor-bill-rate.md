...
description: This topic privdes information about how to set up labor billing rates in Project Operations.
author: rumant
manager: Annbe
ms.date: 10/16/2020
ms.topic: article
...
1. To setup labor bill rates for a sales price list, create a price list based on the price list header. 
...
3. On the **Quick Create** pane, enter the role and organization unit combination for which you need to set up the bill rate.
   ...
   The following table includes the fields on the **General** tab and the **Quick Create** pane of a role price line that you need keep in mind as you create role prices on a sales price list:
    ...
    | Currency | **General** tab and **Quick Create** pane| By default, the currency value comes from the currency on the sales price list header. On a sales price list, this can't be overridden. | This currency is the default currency on the per unit price of the incoming actual sales line for Time transaction class. |
...
2. In the sales price list, enter the following rate information:
    ...
    | Developer | Fabrikam Phillipines | Fabrikam Phillipines - Robotics | $90 |
    | Developer | Fabrikam US | Fabrikam US - Robotics | $150 |

3. Attach the sales price list, **Fabrikam US Bill rates** to the project price list of the project conntract or to a certain account.
