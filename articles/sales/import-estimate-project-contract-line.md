...
1. On the **Contract Line Details** tab, select **Import from Project Estimation** on the subgrid. A dialog box with summarization options opens. The available summarization options are **Transaction Class**, **Category**, **Role**, and **Project task**. Based on the selections for summarization, the estimate from the project for all of the transaction classes included on this contract line are copied over. 
1. To check what transaction classes are included, on the **General** tab of the contract line, check the values in the **Include Time**, **Include Expenses**, and **Include Fees** fields.

When you import estimates, the application defaults the pricing based on the project price lists attached to the contract and the billing type set up on the contract line. If you set up a role or category on the contract line as nonchargeable, the imported estimate line for that role or category is nonchargeable and doesn't add to the contracted value of contract line.
