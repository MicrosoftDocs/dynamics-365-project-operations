...
| **Transaction Class** | **Quick Create** | This list of transaction classes is included on the **General** tab of the project-based contract line. | This field value defaults to the related contract line detail for cost that is automatically created. |
