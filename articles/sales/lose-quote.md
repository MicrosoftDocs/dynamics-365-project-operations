...
| --- | --- | --- |
| Article | Enter the relevant topic, or name, of the target quote. When the dialog opens, the system will set it to the article of the source quote with **-copy** appended to it. | |
