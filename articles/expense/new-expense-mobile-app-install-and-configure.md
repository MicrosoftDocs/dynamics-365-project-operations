...
This step is optional. Virtual entities in **Dataverse** will be refreshed automatically as part of installtion process. Perform this step only in case if encounter any issues related to data on the the Mobile app screens.
