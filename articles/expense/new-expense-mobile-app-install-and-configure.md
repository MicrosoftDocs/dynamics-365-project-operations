...
To run the Expense mobile app, you must use below Dynamics 365 Finance version with the latest quality update (QU) or later.
* 10.0.35 - 10.0.1627.120 and above
* 10.0.36 - 10.0.1695.68 and above
* 10.0.37 - 10.0.1725.37 and above
