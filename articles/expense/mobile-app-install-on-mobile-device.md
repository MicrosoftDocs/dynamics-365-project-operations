...
description: Learn how to install and open the Dynamics 365 expense management mobile app on your device. Follow simple steps to get started with managing expenses on the go.
author: mukumarm
ms.date: 01/30/2026
ms.topic: how-to
ms.custom: 
...
1. Install the Microsoft Power Apps mobile app by following the instructions in [Install the Power Apps mobile app](/power-apps/mobile/run-powerapps-on-mobile).
