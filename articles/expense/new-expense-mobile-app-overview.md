...
> [!NOTE]
>The Expense mobile app replaces the now-deprecated [Expense Management mobile workspace](https://learn.microsoft.com/en-us/dynamics365/project-operations/expense/expense-using-mobile).
