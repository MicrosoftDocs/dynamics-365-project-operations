...
* **Approvals** - This tab shows all the expense reports pending for approval across all companies. It allows you to approve, reject, or delegate the expense reports. For more information about approvals, see [Manage approvals by using the Expense mobile app](mobile-app-manage-approvals.md).
