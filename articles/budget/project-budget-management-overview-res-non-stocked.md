...
In a resource nonstocked deployment, you create, approve, and revise budgets, as well as edit projects, on the project page of the Microsoft Dataverse environment.

For an overview of all actions that you can perform on project budgets in Dataverse by using a Core deployment, see [Project budget management](../pro/budget/projectbudgetmanagement.md). You can perform these actions in the Dataverse part of resource non-stocked deployments as well.
...
:::image type="content" source="media/1-Budgetmanagementoverviewresourcenonstocked.png" alt-text="Screenshot of business process flow diagram for project budget management in Project Operations.":::
...
1. If the project budget is approved, all actuals that you created and approved for time, materials, and expenses are matched against the project budget lines. Actual budget consumption and forecasts are automatically updated, and any variance between the budget and actuals is shown.
...
You can create a project budget for all types of projects (fixed-price, time and material, and investment), for both cost budgets and sales budgets.
