...
|Project Planning and Tracking|**Use Project schedule APIs to edit resource assignment contours** </br> </br>The resource assignment contour editing API lets developers programmatically specify a task assignee's effort across any supported date range for more granular time phased effort planning.|[Use Project schedule APIs to perform operations with Scheduling entities](/dynamics365/project-operations/project-management/schedule-api-preview)|
