...
- Project Operations in a Microsoft Dataverse environment version 4.161.0.1688.

## Features included in this release

| **Feature area** | **Feature name** | **More information** |
| --- | --- | --- |
| Project Invoicing |**Billing Hub Phase 3** <br><br> The latest updates on Billing Hub address customer feedback for better visibility and control, reduce manual effort, and align with the long-term goal of making Billing Hub the central invoicing workspace. <br> The updates can be accessed by enabling the flag 'Enable Billing Hub updates'. Key enhancements include: Visibility for 'Not Ready to Invoice' transactions, Streamlined Invoice Creation, Instant Amount Calculations & Notifications, Performance & UX Enhancements | |
...
| Project Management |**Copy project new experience** <br><br> The new copy experience allows Project Managers to copy projects by setting configurations like Project name, Calendar template, Schedule mode, Contracting unit, Currency, and more. The flow can also be customized as per your needs and copy projects to new or existing projects with no Work Breakdown Structure.| |
| Project Management |**Copy externally scheduled projects** <br><br> The new copy experience brings along the copy project capability for an externally scheduled project. Now project managers can easily copy projects to new and existing projects with no WBS. This feature brings parity for externally scheduled projects.| |
...
| --- | --- | --- |
|Time Entry|	4583099|	Import From Resource Assignments imports for incorrect days|
|Billing and Pricing|	5070121|	Unexpected error while updating applied advance amount on a confirmed invoice line |
...
|Subcontracting|	5361570|	Defaulting for Unit and Unit Group isn't working correctly for Subcontract Line|
|Time Entry|	5389918|	Vendor Field isn't defaulted in Actual with subcontract and subcontract line|
|Subcontracting|	5534458|	Tax on the vendor invoice lines is incorrectly assigned to unbilled sales actuals|
