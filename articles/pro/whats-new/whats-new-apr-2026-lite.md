...
- Project Operations in a Microsoft Dataverse environment version 4.166.3426.2.

## Features included in this release

| **Feature area** | **Feature name** | **More information** |
| --- | --- | --- |
| Project Management |**Calendar control updated from Version 1 to Version 2** <br><br> This update introduces a new calendar control with improved accessibility compliance. | |
| Project Management |**Team Member Grid Update** <br><br> The Team Member grid for projects is updated to a more accessibility compliant grid with an overall improved user experience. | |
| Team Member Experience |**Enhanced Team Member Experience (Preview)** <br><br> Users of the Project Operations Team Member app now get two new views (Assignments and Projects) to keep track of assigned tasks and projects where they're staffed as members. The enhanced experience also allows team members to maintain private checklists, notes, and log time entries in a streamlined manner based on assigned work. | [Enhanced Team Member Experience in Project Operations](../../time/enhanced-team-member-experience.md) |
| Time Entry |**Show and Hide Columns from the Modern Time Entry Grid (Early Access Feature)** <br><br> Users can now visibly hide or show columns from the Modern Time Entry Grid, without losing information from those columns while creating new in-line time entries. <br><br> **Note:** This feature of the Modern Grid is available in **early access** for two months, after which the **Modern Grid is the default time entry grid**. This change takes place in the **4.168.X.X version** of Project Operations. | [Show and Hide columns in Modern Grid](../../time/modern-time-entry-grid.md#show-and-hide-columns-from-the-grid-without-losing-information) |
...
| --- | --- | --- |
| Billing and Pricing | 6225696 | Automated Invoice Creation batch job isn't working because the job waits forever. |
| Billing and Pricing | 6226435 | Amount calculation discrepancy for Pending Transactions on the Modern Invoice form. |
| Billing and Pricing | 6226438 | Invoice revision: Refunded retainer doesn't show up. |
...
| Resource Management | 5847284 | Partial Bookings made from "Hourly" view don't reflect on the Team Members grid. |
| Sales | 5744203 | Billing type isn't defaulting on update of role within Quote Line Details. |
