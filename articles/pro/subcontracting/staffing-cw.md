...
description: Learn how to resolve staffing challenges by leveraging contract workers in Dynamics 365. Follow clear steps to manage subcontract lines and update costs.
author: rumant
ms.date: 02/04/2026
ms.topic: how-to
ms.custom: 
