...
2. Enter the required information, and then select **Save**.
    ...
    | Status Reason | The status of the subcontract. The supported values are:</br>• Draft </br>• Confirmed</br>• Closed </br>• Canceled</br>| The status determines whether the subcontract can be edited. Only subcontracts that have a status of **Draft** status can be edited. | 
