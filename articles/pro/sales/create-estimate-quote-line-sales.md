...
To create quote line details, select **+ New quote line detail** on the **Quote Line Details** subgrid. A quick create slider will open. The following table provides details for the fields on the **Quote Line Detail** page and the how the values impact the functionality:

| **Field** | **Location** | **Description** | **Downstream impact** |
| --- | --- | --- | --- |
| Description | Quick create | A description of the specific estimate. | This field value defaults to the related quote line detail for cost that is automatically created. |
| Transaction Class | Quick create | This drop-down list provides the transaction classes that are included on the **General** tab of project-based quote line.  | This field value defaults to the related quote line detail for cost that is automatically created. |
| Select Product | Quick create | Applies when the transaction class is **Material**. You can select to specify that this estimate line is for an **Existing** (catalog) product or a **Write In** product. | This field value defaults to the related quote line detail for cost that is automatically created. |
| Product | Quick create | The ID of the product from the product catalog. This field is only enabled if you select **Existing** in the **Select Product** field. The ID is used to retrieve the sales price from project price list on the quote. | This field value defaults to the related quote line detail for cost that is automatically created. |
| Write In Product | Quick create | A text box to write in name of the product. This field is only enabled if you select **Write In** in the **Select Product** field.| This field value defaults to the related quote line detail for cost that is automatically created. |
| Role | Quick create | The role of the person that will perform this work or incur this expense. | This field value defaults to the related quote line detail for cost that is automatically created. |
