...
| Transaction Class | Quick create | This drop-down list provides the transaction classes that are included on the **General** tab of the project-based quote line.  | This field value defaults to the related quote line detail for cost that is automatically created. |
...
| Write In Product | Quick create | A text box to write in the name of the product. This field is only enabled if you select **Write In** in the **Select Product** field.| This field value defaults to the related quote line detail for cost that is automatically created. |
...
| Unit schedule | Quick create | The unit group of the work, product, or expense. Units belong to a unit schedule or a group of units. For example, miles and kilometers are units that belong to a group of units that describes distance. | This field value defaults to the related quote line detail for cost that is automatically created. |
