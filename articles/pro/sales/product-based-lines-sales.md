...
Product opportunity lines are line items on the Opportunity that don't reference a project. These distinct line items appear on the eventual invoice that you provide to the customer. The invoice doesn't include any other additional services. The associated spend and consumption isn't tracked on tasks of any related projects.
