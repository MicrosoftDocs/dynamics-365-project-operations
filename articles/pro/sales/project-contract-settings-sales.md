...
| Potential Customer | **Summary** tab | The reference to the customerss company or account record. When a contract is created from a quote, this field is copied from the corresponding field on the quote record. | The currency on the project contract defaults based on the currency of the customer. This can be changed before the contract is saved. |
