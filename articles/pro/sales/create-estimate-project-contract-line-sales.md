...
| **Transaction Class** | **Quick Create** | This is a list of transaction classes included on the **General** tab of the project-based contract line. | This field value defaults to the related contract line detail for cost that is automatically created. |
| **Select Product** | **Quick create** | Applies when the transaction class is **Material**. You may specify this estimate line is for an **Existing** (catalog) product or a **Write in** product. | This field value defaults to the related contract line detail for cost that is automatically created. |
