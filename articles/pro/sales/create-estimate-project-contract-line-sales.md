...
| **Select Product** | **Quick create** | Applies when the transaction class is **Material**. You can specify if this estimate line is for an **Existing** (catalog) product or a **Write in** product. | This field value defaults to the related contract line detail for cost that is automatically created. |
