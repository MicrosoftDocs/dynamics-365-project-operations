...
1. Make any required updates, and then, on the Action Pane, select **Save** or **Save & Close**. Depending on your updates, the budget period detail line is extended, or it's deleted and then re-created.
...
| End year | Mandatory | <p>Specify the calendar year that the budget period is created until.</p><p>For example, if the **End year** field is set to **2033**, the budget period ends in 2033, in the month that's specified in the **End month** field.</p> | Updates to this field extend the budget period details. |
| End month | Mandatory | <p>Specify the month that the budget period is created until.</p><p>For example, if the **End year** field is set to **2033**, and the **End month** field is set to **June**, the budget period ends the last week of June 2033.</p> | Updates to this field extend the budget period details. |
