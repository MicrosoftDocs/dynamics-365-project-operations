...
1. Select the project to create the **Expense** budget line for. Because you previously created a project budget, you should see the **Budget** tab.
...
1. You can edit budget line fields in the grid on the **Budget** tab. Changes are saved when you select the **Tab** key to move to the next line in the grid. You can make edits only until you submit the budget for approval.
...
| Unit Group | Optional | By default, if you select a transaction category in the **Transaction category** field, this field is set to the unit group of that transaction category. If you leave the **Transaction category** field blank, you can select a unit group in this field. |
| Unit | Optional | By default, if you select a transaction category in the **Transaction category** field, this field is set to the unit of that transaction category. If you leave the **Transaction category** field blank, you can select a unit in the list of units for the selected unit group. If the unit that you select isn't in the list of units for the selected unit group, the **Unit group** field is cleared, so that the correct unit group for the selected unit can be selected. |
