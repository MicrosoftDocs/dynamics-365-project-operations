...
1. Ensure you're using Project Operations version _4.91.0.X_ or later. This feature is only available from this version onward. Project Operations version _4.103.0.X_ or later provides multi-factor recommendations, while versions prior to _4.91.0.X_ only provide single factor (Relevant Past Experience) recommendations.
