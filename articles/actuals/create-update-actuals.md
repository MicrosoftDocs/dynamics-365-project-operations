...
- Create or update actuals by using Microsoft Power Automate flows that invoke the native Project Operations APIs that are mentioned in the "Supported fields" table later in this article.
