...
Entry journals can be used to create actuals outside of the standard process of submitting and approving a time/material/expense entry. It's meant to be used for situations where creating individual entries is infeasible, including data migration.
