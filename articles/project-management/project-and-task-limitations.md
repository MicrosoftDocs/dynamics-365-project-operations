...
| Maximum total links (successor only) for a project | 2000                  |
...
> [!NOTE]
> *Duration in days is calculated using an 8-hour workday. If the project's "Hours per Day" setting differs, the maximum task and project duration values will adjust accordingly.
