...
| Project Label           | No         | Yes        | No         | Label names can be changed. This feature is only available for Project for the Web. Labels are created the first session a project is opened.                                                                                                                                                                                                                                                                       |
...
-   Labels are created the first session a project is opened.
