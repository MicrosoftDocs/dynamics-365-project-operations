...
7. This navigates you to a Power Query page, with details for the selected dataflow. Select the **_EnvironmentName_ parameter** and within the space provided for **Current Value** enter the URL of the environment being used. _(Eg: demo-testing.crm.dynamics.com)_ then select **Manage Parameter**.
8. ...
9. ...
10. ...
