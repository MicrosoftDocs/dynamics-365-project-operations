...
3. Select the **Work Hours** tab of the resource and complete the instructions in [Set work hours for a resource](/field-service/set-work-hours-resource.md) to configure the calendar rules.
