...
3. At the top left of the grid, there's a view switcher that allows the selection of **Expenses** or **Materials**.
4. Once **Materials** is selected, all materials are visible.
