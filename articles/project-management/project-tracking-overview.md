...
- Approved Effort on a summary task is the sum of the approved effort on all child tasks plus the approved effort on the summary task
- Remaining Effort on the summary task is the sum of the remaining effort on all child tasks minus the approved effort on the summary task.
