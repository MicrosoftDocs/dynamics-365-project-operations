...
description: Learn how to manage project team members, including attributes, scheduling, and resource assignments, to ensure successful project execution.
author: abriccetti
ms.date: 02/05/2026
ms.topic: overview
...
Project team members are the project participants who complete the work on a project. The objective of the team member grid is to provide a list of named resources who are committed to the engagement, and generic team members who are placeholder resources and are staffed later.

From the team member grid, the project manager and the other project participants can see who is committed to the project. They can also view a summary of their bookings, planned effort, and individual resource assignments. The team member grid allows project managers to define resource requirements for generic team members and manage the bookings of existing team members.
...
From the team member grid, take the following actions:
...
- **Delete**: If you select one or many team members, the project manager can delete resources who are no longer participating on the project. Deleting a team member also deletes all associated resource assignments and cancels all existing bookings. The delete operation is asynchronous and might take some time to complete. During this process, you can't modify the team member record. The **Delete status** attribute tracks the status of the delete action. If the delete operation doesn't succeed within three minutes, the **Delete status** updates to **Error** and then you can retry the delete action.
