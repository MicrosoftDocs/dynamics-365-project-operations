...
1. Select the task to indent or promote. To select more than one task, select a task, select and hold the **Ctrl** key, and then select more tasks.
1. Select **Indent** or **Promote subtask** to move tasks under or out from under summary tasks.
...
1. Adding or removing attachments
1. Edits to any custom columns
