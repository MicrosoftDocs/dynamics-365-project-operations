...
description: This article provides a sample flow that uses the Project schedule V2 application programming interfaces (APIs).
author: abriccetti
ms.date: 09/20/2023
ms.topic: article
...
The example in this article uses the API PssCreateV2. For an example using PssCreateV1 see Use V1 Project schedule APIs with Power Automate
...
## <a id="9"></a>Step 9: Initialize array
