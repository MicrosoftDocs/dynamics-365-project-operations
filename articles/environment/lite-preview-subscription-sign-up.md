...
> [!NOTE]
> This process changes in upcoming releases of Project Operations.
...
> [!IMPORTANT]
> Only one person, the tenant administrator, in an organization needs to perform this task. If you're not the subscriber to this release, wait until your organization is signed up and you receive your user credentials.
> 
> Trials are single use in the tenant. You can only run a trial one time. Create a new tenant for the purpose of the trial.

### Dynamics 365 Project Operations trial 

Before you begin, make sure you're signed in to a browser by using the user work account in the tenant where you want the Project Operations preview.

1. Go to [Project Operations Trial](https://aka.ms/try-po) to redeem the first offer code, **Dynamics 365 Project Operations**.
1. Confirm your order.

  You see the confirmation that the offer was successfully redeemed.
...
1. Verify that the **Dynamics 365 Project Operations** license is selected. 
...
1. Select the **Enable Dynamics 365 apps** setting, and leave **Automatically deploy these apps** blank.  
1. Select **Save** to create the environment.

  :::image type="content" source="./media/20CreateEnvironment1.png" alt-text="Screenshot of the Add database dialog.":::

1. After the environment is created, install **Microsoft Dynamics 365 Project Operations** solution. 

:::image type="content" source="./media/21InstallSolution.png" alt-text="Screenshot of the Install Solution dialog.":::
