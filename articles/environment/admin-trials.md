...
- To configure security roles for dual-write, see [Update security settings on Project Operations in Dataverse](https://docs.microsoft.com/en-us/dynamics365/project-operations/environment/resource-provision-new-environment#update-security-settings-on-project-operations-on-dataverse).
