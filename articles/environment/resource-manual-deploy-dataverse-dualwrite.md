...
During deployment through Microsoft Dynamics Lifecycle Services, if you've followed the instructions in this article, you can skip the deployment of the Microsoft Power Platform integration (previously known as the Common Data Service environment).
...
1. Wait until the installation is completed. Then select each of the following in the app list and install them.
