...
Choose this deployment when you expect Project Operations to use the full project lifecycle that includes the following requirements:
...
- A rich, enterprise-class sales tax and exchange rate engine to generate customer-facing invoices for projects.
