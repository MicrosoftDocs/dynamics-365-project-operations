...
After you provision Project Operations as described in this article, the Lifecycle Services **Environment details** page provides easy access to both components of Project Operations.  
...
Select **Login** > **Log on to environment** to navigate to the **Project management and accounting** module in Finance.  
   ...
   :::image type="content" source="./media/environment-login.PNG" alt-text="Screenshot of the login options to access the Finance environment.":::
