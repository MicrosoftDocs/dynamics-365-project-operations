...
Microsoft Dynamics 365 Project Operations provides the Process Project Approval Sets API. Use this API to programmatically process approvals through Microsoft Power Automate or a custom plug-in.
