...
The following tables outline the data that is available to the agent without customization. Customizing this data is outlined [here](approvals-agent-customization.md).
