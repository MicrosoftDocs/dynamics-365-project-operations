...
| --- | --- | --- |
| Time Entry |**Time Entry Delegation (Production Ready Preview)** <br><br> This preview feature lets team members add another user for a date range as a delegate who can view, edit, and submit time entries on their behalf.| |
