...
There are no updates for Project Operations dual-write maps in this release. For the latest list and versions of Project Operations dual-write maps, see [Project Operations dual-write map versions](../environment/resource-dual-write-maps.md).
