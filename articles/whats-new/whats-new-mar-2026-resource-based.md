...
| Project Financials |**Use the modern architecture for existing legal entities with project data** <br><br> Additional scenarios were added to the feature to support sales orders, item requirements, and sales agreements in existing PMA projects.| [Move to the modern architecture](../prod-pma/move-to-modern-architecture.md) |
