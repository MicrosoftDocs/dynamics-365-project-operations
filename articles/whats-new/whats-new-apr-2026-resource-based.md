...
The Project Operations April 2026 release doesn't include any changes to dual-write maps.
...
| Time Entry |**Show and Hide Columns from the Modern Time Entry Grid (Early Access Feature)** <br><br> Users can now visibly hide or show columns from the Modern Time Entry Grid, without losing information from those columns while creating new in-line time entries. <br><br> **Note:** This feature of the Modern Grid is available in **early access** for two months, after which the **Modern Grid is made the default time entry grid**. This change takes place in the **4.168.X.X version** of Project Operations. | [Show and Hide columns in Modern Grid](../time/modern-time-entry-grid.md#show-and-hide-columns-from-the-grid-without-losing-information) |
