...
The following tables document all deprecated fields that are moved to the deprecated components solution post upgrade. For more information and a link to the solution, see [Dynamics 365 Project Service Automation 3x to Project Operations 4x deprecated components](/Dynamics365-Project-Operations-PowerApps/tree/main/3x-4x-deprecated-solution).
