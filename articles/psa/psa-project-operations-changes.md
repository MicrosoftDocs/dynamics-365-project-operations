...
The upgrade from Dynamics 365 Project Service Automation to Dynamics 365 Project Operations Project Operations Core will be delivered in three phases. This article provides information about the major changes that you can expect to see when the upgrade is complete.
