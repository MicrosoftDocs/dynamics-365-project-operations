...
### Features
Phase 1 of upgrade from Project Service Automation to Project Operations Lite will be rolling out in February 20222 to all cusstomers, see article for criteria in Phase 1.   If the app does not appear in your instance, please contant support and request the flight to be enabled for your environments, please specify each environment ID where the flight needs to be enabled.
