...
As a starting point, import all customizations into a clean Project Operations  Core environment to confirm that import is successful, and that business operations behave as expected.
...
### Upgrade to Project Operations  Core
...
|--------------------------------------------------------|-----------------------------------------------------------|-------------------------|
| Project Service Automation                             | Project Operations  Core                        | Supported               |
| Dynamics 365 Finance Project Management and Accounting | Project Operations  Core                        | Not currently supported |
| Finance Project Management and Accounting              | Project Operations Integrated with ERP scenarios     | Not currently supported |
| Project Service Automation 3.x                         | Project Operations Integrated with ERP scenarios     | Not currently supported |
| Project for the Web (dedicated environment)            | Project Operations  Core                        | Not currently supported |
