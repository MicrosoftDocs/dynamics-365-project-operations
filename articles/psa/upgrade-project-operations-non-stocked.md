...
|--------------------------------------------------------|-----------------------------------------------------------|-------------------------|
| Project Service Automation                             | Project Operations Project Operations Core                        | Supported               |
| Dynamics 365 Finance Project Management and Accounting | Project Operations Project Operations Core                        | Not currently supported |
...
| Project for the Web (dedicated environment)            | Project Operations Project Operations Core                        | Not currently supported |
