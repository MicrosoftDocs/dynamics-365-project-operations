...
> [!IMPORTANT]
> - The add-in is available only for existing Project Operations customers who either have active usage of the add-in or have projects that are currently outside the supported limits of Project for the Web.
