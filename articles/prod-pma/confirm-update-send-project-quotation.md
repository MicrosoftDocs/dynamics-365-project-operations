...
1. On the **Project quotation** page, select the quotation you want to send for confirmation. 
1. On the **Follow up** tab, in the **Generate** group, select **Confirm**. 
1. On the **Confirm quotation** page, set the required parameters. For example, to print the confirmation, under **Print** options, turn on **Print confirmation**, and then select **OK**.
1. On the **Send quotation** page, select **Options**.
1. On the **Print destination settings** page, select **OK**.  
...
1. On the **Project quotations** page, select the quotation you want to update. On the Action Pane, select **Edit**.
1. Update the necessary field information. On the Action Pane, select **Save**.  
...
1. On **Project quotations**, on the **Quote** tab, in the **Process** group, select **Send quotation**. The quotation status updates to **Sent**.

> [!NOTE]
> You can't modify a project quotation after you change the status to **Sent**.
