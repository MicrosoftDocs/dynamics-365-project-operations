...
| Project management and accounting | [548999](https://fix.lcs.dynamics.com/Issue/Details/?bugId=548999) | When the items are received and issued partially from the item   requirement, the system updates the wrong budget consumption balance. |
...
| Project management and accounting | [563840](https://fix.lcs.dynamics.com/Issue/Details/?bugId=563840) | You can't add a personalized **Purpose** or **Activity description** field to the **Project posted transaction** page, **Invoice proposal creation** page, or the **Invoice proposal** page.  |
...
| Project management and accounting | [571339](https://fix.lcs.dynamics.com/Issue/Details/?bugId=571339) | There is an error in the credit note invoice proposal posting. The   transactions on the voucher don't balance.    |
...
| Travel and Expense                  | [546450](https://fix.lcs.dynamics.com/Issue/Details/?bugId=546450) | Release Update **DB72_Expense.updateTrvExpTransProjTransId()**   doesn't honor **trvExpTrans.ReferenceDataAreaId** to create the new number sequence.                    |
| Travel and Expense                  | [568805](https://fix.lcs.dynamics.com/Issue/Details/?bugId=568805) | The aount filed isn't showing with the mandatory field.                                                                                                             |
...
| Travel and Expense                  | [523557](https://fix.lcs.dynamics.com/Issue/Details/?bugId=523557) | The **Reset Expense document status'** tool should be able to reset the expense report status to **Draft** if the workflow wasn't found. 
