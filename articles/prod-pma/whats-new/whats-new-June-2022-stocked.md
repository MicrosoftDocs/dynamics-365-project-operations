...
Enabled using item requirements for project contracts with multiple funding sources . For more information, see [Item requirements for project contracts with multiple funding sources](https://docs.microsoft.com/en-us/dynamics365/project-operations/prod-pma/multiple-funding-sources-item-req).
