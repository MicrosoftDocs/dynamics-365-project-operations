...
3. Intercompany unbilled sale transactions are recorded in the lending company by using borrowing company's unit cost price list.
...
For more information about intercompany invoicing, see:
