...
The posting specifications in Project Operations are defined by the project cost adn revenue profile rules, project categories, and cateogry groups. You can set up category groups by going to **Project management and accounting** \> **Setup** \> **Categories** \> **Category groups**.
